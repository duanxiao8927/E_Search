...
public class HttpEngine {
    ...
    public <T> T getHandle(String httpUrl,Map<String, String> paramsMap, Type typeOfT)  {
        ...
        httpUrl = httpUrl + "?" + joinParams(paramsMap);
        try {
            ...
            connection.setRequestProperty("apikey","3104196bbb06d75ceb27755e8b56688e");
            connection.connect();
            InputStream is = connection.getInputStream();
